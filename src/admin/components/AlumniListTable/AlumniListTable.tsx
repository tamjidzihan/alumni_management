...
import CreateAmulniModel from './CreateAmulniModel';
...
const AlumniListTable = () => {
    ...
    return (
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            {/* List of Events */}
            {Alumnilist.length > 0 ? (
                Alumnilist.map((event: EventsProps) => (
                    <div
                        key={event.id}
                ...
                <div className="text-center py-4">
                    <p className="text-gray-500">No Alumni List Found.</p>
                </div>
            )}
        </div>
    );
